...
//        echo "Генерация страницы с правилами покупки картин";
        $content='recipes.php'; // имя файла с контентом
...
// метод генерации страниц
    public function renderPage($content,$template,$data=[]){
        ...
        // в файле template.php на место переменной $content подставится ее значение - recipes.php, получается, что
        // в файле template.php подключили файл recipes.php (содержимое этого файла)
