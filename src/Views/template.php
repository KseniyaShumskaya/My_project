...
<body>
<nav class="headline">
<div class="funny-title section-title">
    <a class="navbar-brand" href="/"> "Если бы мне сказали, что завтра наступит конец света, то еще сегодня я посадил бы дерево."<br>
        Мартин Лютер</a>
...
<nav class="slider">
    <div id="slider">
        <p>вставить слайдер с деревьев</p>
    </div>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/article/show">Виды деревье</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/info/rules">Отростки</a>
                </li>
